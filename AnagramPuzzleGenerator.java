/**
* Assignment #1.
* This program generates anagrams using a file specifed during execution
*
* Authors: Jorge Henriquez (joahenri@ucsc.edu)
* CMPS12A
* Professor: Delbert Bailey
* CMPS 12L Seciton D
*/
...
public class AnagramPuzzleGenerator{
  ...
  public static void main(String[] args) throws FileNotFoundException{
    ...
    while( i <= randNumber ){
      ...
      if( i == randNumber ){ //Once the loop hits the last number:
